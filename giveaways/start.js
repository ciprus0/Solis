...
const config1 = require('../config.json')
  ...
  await client.giveawaysManager.start(giveawayChannel, {
    ...
    hostedBy: client.config1.hostedBy ? message.author : null,
    // Messages
    messages: {
      giveaway:
        (client.config1.everyoneMention ? "@everyone\n\n" : "") +
        "<:tadas:846940408910053427> **GIVEAWAY** <:tadas:846940408910053427>",
      giveawayEnded:
        (client.config1.everyoneMention ? "@everyone\n\n" : "") +
        "<:tadas:846940408910053427> **GIVEAWAY ENDED** <:tadas:846940408910053427>",
